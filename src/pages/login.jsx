      ...
      <div className='fixed w-full px-4 py-16 z-50'>
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
          <div className='max-W-[320px] py-16 mx-9  '>
            <h1 className='text-3xl font-bold mx-9'>Sign In</h1>
            ...
            <form  onSubmit={handleSubmit}className='w-full flex flex-col py-4 '>
              ...
              <input 
              onChange={(e) => setPassword(e.target.value)}   className='p-3 my-2 bg-gray-700 rounded'type="password" placeholder='password' />
